...
XXX: This is a proof-of-concept, we we decide to go this way for packaging,
we'll need to rework these a bit.
"""
...
def sync_slurm_acct_main():
    """
    Sync accounts from the VSC accountpage to the slurm DBD.
    """
